        ...
        <div className={" mt-10 flex gap-8 items-center flex-col"}>
          <div className="flex  flex-col items-start  mx-5">
            <div className="flex  flex-col gap-2  ">
              ...
              <Separator />
              <p className="text-md font-normal leading-relaxed tracking-tight text-muted-foreground max-w-2xl ">
            ...
            <div className="flex items-center justify-between gap-1 mt-9 mb-21">
